...
if( $_SESSION['lenguaje']=="ES"){
   ...
   echo"<div style='clear: both;'></div><div class='principal'><h1> Definición de Problemas, Marcos de trabajo </h1>";
   ...
   <form action='insertarproblemas.php' method='post'>
     ...
     <br><br>
     <textarea name='nombreproblema' rows=4 cols='40'></textarea> 
     <input type='hidden' name='idpro' value='-1'>  
     <br><br>
 ...
 echo"  <table border='1px' align='center'>
  ...
  echo"<div style='clear: both;'></div><div class='principal'><h1> PROBLEMS DESCRIPTION AND FRAMEWORK DEFINITIONS </h1>";
